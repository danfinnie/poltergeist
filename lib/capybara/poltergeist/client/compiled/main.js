...
Poltergeist = (function() {
  function Poltergeist(sync_port, async_port, width, height) {
    var that;
    this.browser = new Poltergeist.Browser(this, width, height);
    this.connection = new Poltergeist.Connection(this, sync_port, async_port);
    that = this;
  ...
  Poltergeist.prototype.sendAsyncResponse = function(response) {
  ...
  Poltergeist.prototype.sendAsync = function(data) {
